...
import com.ibm.garage_catalyst.rest_template.support.HttpConnectionKeepAliveStrategy;
...
public class RestTemplateBuilder {
    ...
    protected List<ClientHttpRequestInterceptor> buildInterceptors(ClientHttpRequestInterceptor loggingInterceptor) {
        return Collections.singletonList(Optional.ofNullable(loggingInterceptor).orElse(new OutboundLoggingInterceptor()));
    }
