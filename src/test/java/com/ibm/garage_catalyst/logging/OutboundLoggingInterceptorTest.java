...
class OutboundLoggingInterceptorTest {
    private OutboundLoggingInterceptor classUnderTest;
    private RequestResponseLogger delegateMock;
    ...
    class GivenIntercept {
        ...
        void exception() throws IOException {
            ...
            assertThrows(IOException.class, () -> classUnderTest.intercept(request, body, execution));
