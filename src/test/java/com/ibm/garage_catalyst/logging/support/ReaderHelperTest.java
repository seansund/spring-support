...
class ReaderHelperTest {
    ...
    class GivenPrivateConstructor {
        ...
        void setup() {
            constructor = of(ReaderHelper.class.getDeclaredConstructors())
    ...
    class GivenReaderToString {
        ...
        class WhenReaderContainsTestValue {
            ...
            void thenReturnTest() throws IOException {
                ...
                when(reader.readLine()).thenReturn(value1, value2, null);

                assertEquals(
                        of(value1, value2).collect(joining(lineSeparator())),
        ...
        class WhenReaderThrowsAnException {
            ...
            void thenThrowException() throws IOException {
                ...
                assertThrows(ReaderHelper.LineReadError.class, () -> ReaderHelper.readerToString(reader));
            }
        }
    }
