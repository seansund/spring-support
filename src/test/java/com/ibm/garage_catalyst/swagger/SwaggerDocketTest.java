package com.ibm.garage_catalyst.swagger;
...
class SwaggerDocketTest {
    ...
    private SwaggerDocket classUnderTest;
    private SwaggerDocket classUnderTestSpy;

    @BeforeEach
    void setup() {
        config = new SwaggerConfig();

        classUnderTest = new SwaggerDocket(config);
    ...
    class GivenBuildApiRequestHandler {
        @Test
        void empty_baseApiPackage_returns_any() {
        ...
        void nonEmpty_baseApiPackage_returns_basePackage() {
    ...
    class GivenBuildContact {
        @Test
        @DisplayName("When config.contact is null then it should return null")
        void null_config_contact_should_return_null() {
        ...
        void nonNull_config_contact_should_return_contact() {
